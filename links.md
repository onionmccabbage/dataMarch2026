...
Good for comparisons, but can't see actual values easily
Chaotic, disjointed, info overload, no thread
Eye is jumping all over. Brain tries to pull together the thread
Lacking overall context, what is the main point?
Information laid out very good, giving everything needed to see global scale, tremendous knowledge in small space of time. Grasps interest, you end up scrolling
Reinforces existing experience/knowledge

Gapminder: wealth of the nations
https://www.gapminder.org/tools/#$chart-type=bubbles&url=v2

A lot of data being presented
Very good comparison across lots of data
Good knowlege in small space area
Easy to draw data out
gives a 'how to use' video - can manipulate what you want to se
Attributes are explained clearly in context
Explains concepts
The colours caught out - what do they mean - see context at the side
Good for overall trend and also dig in to specific details
The play button was less obvious
A title might help

A predominantly positive response from users is good

https://www.reddit.com/r/soccer/comments/twqsh0/how_much_every_club_has_spent_in_the_premier/?rdt=53423
...
https://rigorousthemes.com/blog/bad-data-visualization-examples/
https://www.plecto.com/blog/dashboard-design/6-examples-bad-data-visualizations/
