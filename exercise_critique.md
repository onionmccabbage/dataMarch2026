...
- What actions might it prompt
- How effective is the colour, text, whitespace design etc.
- Are there misleading stories

#### Some samples to choose from (but feel free to find your own)
